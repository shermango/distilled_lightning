defmodule Cards do
  ...
  @doc """
    Returns a list of strings modeling a deck of cards
  """
  def create_deck do
  ...
  ## Examples
      ...
      true
      iex> Cards.contains?(deck, "14 of Spades")
      false
  """
  ...
  @doc """
    Divides a deck into a tuple of `hand` and `rest of deck`, `hand_size` is the hand to split, default to 5
